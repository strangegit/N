  ...
  render() {
    return (
      this.props.basket.length ? <div className={sendme.main}>
        ...
        <input autoFocus ref="email" value={this.state.input} onChange={this.handleInput} type="text" placeholder="Ваш телефон или e-mail" className={sendme.email}/>
        ...
        <textarea value={this.state.textarea} onChange={this.handleTextarea} autoFocus ref="textarea" className={sendme.textarea}></textarea>
